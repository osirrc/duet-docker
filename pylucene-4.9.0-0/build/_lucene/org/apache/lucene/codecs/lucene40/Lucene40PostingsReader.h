#ifndef org_apache_lucene_codecs_lucene40_Lucene40PostingsReader_H
#define org_apache_lucene_codecs_lucene40_Lucene40PostingsReader_H
    ...
    namespace lucene {
      namespace codecs {
        namespace lucene40 {
          ...
          class Lucene40PostingsReader : public ::org::apache::lucene::codecs::PostingsReaderBase {
          public:
            enum {
              mid_init$_b18a8355,
            ...
            explicit Lucene40PostingsReader(jobject obj) : ::org::apache::lucene::codecs::PostingsReaderBase(obj) {
              if (obj != NULL)
                env->getClass(initializeClass);
            }
            Lucene40PostingsReader(const Lucene40PostingsReader& obj) : ::org::apache::lucene::codecs::PostingsReaderBase(obj) {}

            Lucene40PostingsReader(const ::org::apache::lucene::store::Directory &, const ::org::apache::lucene::index::FieldInfos &, const ::org::apache::lucene::index::SegmentInfo &, const ::org::apache::lucene::store::IOContext &, const ::java::lang::String &);
...
namespace org {
  namespace apache {
    namespace lucene {
      namespace codecs {
        namespace lucene40 {
          extern PyTypeObject PY_TYPE(Lucene40PostingsReader);

          class t_Lucene40PostingsReader {
          public:
            PyObject_HEAD
            Lucene40PostingsReader object;
            static PyObject *wrap_Object(const Lucene40PostingsReader&);
